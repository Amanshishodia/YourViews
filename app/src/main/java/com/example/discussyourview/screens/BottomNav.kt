...
import com.example.discussyourview.model.BottomNavItem
...
fun MyBottomBar(navController1: NavHostController) {
    ...
    val list = listOf(
        ...
        BottomNavItem("Add", Routes.AddThread.routes, Icons.Rounded.Add),
        BottomNavItem("Notifications", Routes.Notification.routes, Icons.Rounded.Notifications),
